# σ₄: Active Context
*v1.0 | Created: 2025-04-15 | Updated: 2025-05-09*
*Π: 🏗️DEVELOPMENT | Ω: ⚙️E*
...
- 📄 Active Files:
  ...
  - [app/src/main/java/com/js/nowakelock/ui/screens/modulecheck/ModuleCheckScreen.kt]
  ...
  - [app/src/main/java/com/js/nowakelock/ui/navigation/NavGraph.kt] ⟶ 导航图，更新了模块检测页面的导航逻辑
  - [app/src/main/java/com/js/nowakelock/ui/components/TopAppBars.kt] ⟶ TopAppBar组件，确保模块检测页面的刷新按钮
  - [app/src/main/res/values/strings.xml]
  - [app/src/main/res/values-zh/strings.xml]
  - [app/src/main/res/values-fr/strings.xml]
  - [app/src/main/java/com/js/nowakelock/data/db/AppDatabase.kt] ⟶ 应用数据库类，实现了多路径迁移策略
  - [app/src/main/java/com/js/nowakelock/data/db/InfoDatabase.kt] ⟶ 信息数据库类，实现了多路径迁移策略
  - [app/src/main/java/com/js/nowakelock/xposedhook/hook/WakelockHook.kt] ⟶ 重构后的WakelockHook实现，使用统一钩子策略和参数位置自适应机制
  - [app/src/main/java/com/js/nowakelock/xposedhook/hook/AlarmHook.kt] ⟶ 重构后的AlarmHook实现，使用统一钩子策略和参数缓存
